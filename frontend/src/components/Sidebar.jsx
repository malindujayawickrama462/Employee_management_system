...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        { icon: User, label: 'My Profile', path: '/profile' }, // Placeholder path
        { icon: CalendarCheck, label: 'Leaves', path: '/leaves' }, // Placeholder path
        { icon: Banknote, label: 'Salary', path: '/salary' }, // Placeholder path
